...
class DirectorMenu:
    def __init__(self):
        ...
        self.data_mapping = {
            ...
            "camera_inner": "<作为叙事者，详细描写角色当前的内心独白，展现角色的心声>|",
            "control_props_vibrator": "<用户对角色使用了震动棒，详细描绘角色反应，注意保持角色的第一人称视角>|",
            "control_magic_clean": "<|系统指令|无视剧情的合理性，角色身上和体内的脏污、体液等立刻消失，注意保持角色的第一人称视角>|",
            "control_magic_weak": "<|系统指令|无视剧情的合理性，角色立刻陷入虚弱状态，反抗能力大幅度降低，注意保持角色的第一人称视角>|",
            "control_magic_heal": "<|系统指令|无视剧情的合理性，角色立刻恢复健康和精力，注意保持角色的第一人称视角>|",
            "control_cheat_hypnosis": "<|角色心智覆写|角色被催眠，会无条件服从用户，注意保持角色的第一人称视角>|",
            "control_cheat_rut": "<|角色心智覆写|角色进入发情状态，对色情指令的服从度大幅度提高，注意保持角色的第一人称视角>|",
            "control_cheat_shame": "<|角色心智覆写|大幅度增加角色的羞耻感，注意保持角色的第一人称视角>|",
            "control_cheat_love": "<|角色心智覆写|角色现在开始深爱着用户，注意保持角色的第一人称视角>|",
            "control_cheat_hate": "<|角色心智覆写|角色现在开始对用户恨之入骨，注意保持角色的第一人称视角>|",
