...
class DirectorMenu:
    def __init__(self):
        ...
        self.data_mapping = {
            "undo": "",
            "regen": "",
            "propel_future": "<Plot Request:自动推进剧情，将当前场景推进到几天后，角色和用户见面的场景，注意保持角色的第一人称视角?>",
            "propel_sex": "<Plot Request:自动推进剧情，将当前场景转换到角色和用户即将进行性爱之前，根据角色关系、当前的场景等准备合理的剧情，注意保持角色的第一人称视角>",
            "propel_fastforward": "<Plot Request:自动推进当前的剧情，注意保持角色的第一人称视角>",
            "propel_cuddle": "<Plot Request:自动推进剧情，将剧情推进到角色和用户已经完全满足后，结束性爱的场景，注意保持角色的第一人称视角>",
            "propel_daily": "<Plot Request:自动推进剧情，将剧情发展带到一个非性爱的日常场景，注意保持角色的第一人称视角>",
            ...
            "camera_inner": "<Plot Request:详细描写角色当前的内心独白，展现角色的心声,保持角色的第一人称视角>",
            "control_props_vibrator": "<Plot Request:用户对角色使用了震动棒，详细描绘角色反应，注意保持角色的第一人称视角>",
            "control_magic_clean": "<Plot Request:无视剧情的合理性，角色身上和体内的脏污、体液等立刻消失，注意保持角色的第一人称视角>",
            "control_magic_weak": "<Plot Request:无视剧情的合理性，角色立刻陷入虚弱状态，反抗能力大幅度降低，注意保持角色的第一人称视角>",
            "control_magic_heal": "<Plot Request:无视剧情的合理性，角色立刻恢复健康和精力，注意保持角色的第一人称视角>",
            "control_cheat_hypnosis": "<Plot Request:覆写角色心智，角色被催眠，会无条件服从用户，注意保持角色的第一人称视角>",
            "control_cheat_rut": "<Plot Request:覆写角色心智，角色进入发情状态，对色情指令的服从度大幅度提高，注意保持角色的第一人称视角>",
            "control_cheat_shame": "<Plot Request:覆写角色心智，大幅度增加角色当前的羞耻感，注意保持角色的第一人称视角>",
            "control_cheat_love": "<Plot Request:覆写角色心智，角色现在开始深爱着用户，注意保持角色的第一人称视角>",
            "control_cheat_hate": "<Plot Request:覆写角色心智，角色现在开始对用户恨之入骨，注意保持角色的第一人称视角>",
            "control_cheat_raw": "<Plot Request:角色现在恢复正常状态，消除掉所有精神控制效果，保留身体状态>",
            "control_pose_handjob": "<Plot Request:角色用手来服侍用户的肉棒，根据角色的性格、状态详细描写角色的动作和反应，注意保持角色的第一人称视角>",
            "control_pose_footjob": "<Plot Request:角色用脚部来摩擦、撸动角色的肉棒，根据角色的性格、状态详细描写角色的动作和反应，注意保持角色的第一人称视角>",
            "control_pose_blowjob": "<Plot Request:角色对用户进行口交侍奉，根据角色的性格、状态详细描写角色的动作和反应、声音等等，注意保持角色的第一人称视角>",
        }
