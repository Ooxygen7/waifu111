...
class DirectorMenu:
    def __init__(self):
        ...
        self.data_mapping = {
            "undo": "",
            "regen": "",
            "propel_future": "<自动推进剧情，将当前场景推进到几天后，角色和用户见面的场景>|",
            "propel_sex": "<自动推进剧情，将当前场景转换到角色和用户即将进行性爱之前，根据角色关系、当前的场景等准备合理的剧情>|",
            "propel_fastforward": "<自动推进当前的剧情>|",
            "propel_cuddle": "<自动推进剧情，将剧情推进到角色和用户已经完全满足后，结束性爱的场景>|",
            "propel_daily": "<自动推进剧情，将剧情发展带到一个非性爱的日常场景>|",
            "camera_monitor": "<使用监控的视角，以第三人称的形式描绘当前的场景，聚焦于角色和用户的互动、动作、姿势。角色和用户都不会察觉有监控的存在>|",
