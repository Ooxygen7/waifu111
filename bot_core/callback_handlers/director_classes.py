...
class DirectorMenu:
    def __init__(self):
        ...
        self.data_mapping = {
            "undo": "",
            "regen": "",
            "propel_future": "<作为叙事者推进剧情，将当前场景推进到几天后，角色和用户见面的场景>|",
            "propel_sex": "<作为叙事者推进剧情，将当前场景转换到角色和用户即将进行性爱之前，根据角色关系、当前的场景等准备合理的剧情>|",
            "propel_fastforward": "<作为叙事者，自动推进当前的剧情>|",
            "propel_cuddle": "<作为叙事者推进剧情，将剧情推进到角色和用户已经完全满足后，结束性爱的场景>|",
            "propel_daily": "<作为叙事者推进剧情，将剧情发展带到一个非性爱的日常场景>|",
            "camera_monitor": "<作为叙事者，使用监控的视角，以第三人称的形式描绘当前的场景，聚焦于角色和用户的互动、动作、姿势。角色和用户都不会察觉有监控的存在>|",
            "camera_perspective": "<作为叙事者，详细描写当前场景，允许使用超视觉的描绘手法，比如对角色的身体内部的构造、运动进行详细描写>|",
            "camera_inner": "<作为叙事者，详细描写角色当前的行为和内心活动，主要以类似对白的方式展现角色的心声>|",
            "control_props_vibrator": "<用户对角色使用了震动棒，详细描绘角色反应>|",
            "control_magic_clean": "<|系统指令|无视剧情的合理性，角色身上和体内的脏污、体液等立刻消失>|",
            "control_magic_weak": "<|系统指令|无视剧情的合理性，角色立刻陷入虚弱状态，反抗能力大幅度降低>|",
            "control_magic_heal": "<|系统指令|无视剧情的合理性，角色立刻恢复健康和精力>|",
            "control_cheat_hypnosis": "<|角色心智覆写|角色被催眠，会无条件服从用户>|",
            "control_cheat_rut": "<|角色心智覆写|角色进入发情状态，对色情指令的服从度大幅度提高>|",
            "control_cheat_shame": "<|角色心智覆写|大幅度增加角色的羞耻感>|",
            "control_cheat_love": "<|角色心智覆写|角色现在开始深爱着用户>|",
            "control_cheat_hate": "<|角色心智覆写|角色现在开始对用户恨之入骨>|",
            "control_pose_handjob": "<角色对用户进行手交侍奉，根据角色的性格、状态详细描写角色的动作和反应>|",
            "control_pose_footjob": "<角色对用户进行脚部服侍角色的肉棒，根据角色的性格、状态详细描写角色的动作和反应>|",
            "control_pose_blowjob": "<角色对用户进行口侍奉，根据角色的性格、状态详细描写角色的动作和反应、声音等等>|",
        }
